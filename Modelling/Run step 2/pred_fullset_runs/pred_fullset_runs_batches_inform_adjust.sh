#!/bin/zsh
# chmod +x pred_fullset_runs_batches_inform_adjust.sh
# ./pred_fullset_runs_batches_inform_adjust.sh
...
tpplc "$MODELS_DIR/predict/optmodel15_Pred_match_inform_adjust.tppl" \
  ...
  --subsample-size 1 \
  --resample manual \
  --output "$BIN_DIR/optmodel15_Pred_match_inform_adjust_1000"

MODEL_BIN="$BIN_DIR/optmodel15_Pred_match_inform_adjust_1000"
...
INDEX_LIST=""        # optional explicit list "1, 2, 7 9"

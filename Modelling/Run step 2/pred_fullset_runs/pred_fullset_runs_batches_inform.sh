#!/bin/zsh
# chmod +x pred_fullset_runs_batches_inform.sh
# ./pred_fullset_runs_batches_inform.sh
...
tpplc "$MODELS_DIR/predict/optmodel15_Pred_match_inform.tppl" \
  ...
  --subsample-size 1 \
  --resample manual \
  --output "$BIN_DIR/optmodel15_Pred_match_inform_1000"

MODEL_BIN="$BIN_DIR/optmodel15_Pred_match_inform_1000"

#!/bin/zsh
# chmod +x pred_fullset_runs_batches_inform_pfit.sh
# ./pred_fullset_runs_batches_inform_pfit.sh
...
tpplc "$MODELS_DIR/predict/optmodel15_Pred_match_inform_pfit.tppl" \
  ...
  --subsample-size 1 \
  --resample manual \
  --output "$BIN_DIR/optmodel15_Pred_match_inform_pfit_1000"

MODEL_BIN="$BIN_DIR/optmodel15_Pred_match_inform_pfit_1000"

...
#chmod +x pred_spikeins_runs_batches_art.sh
#./pred_spikeins_runs_batches_art.sh
...
ORIG_JSON="$DATA_DIR/modified_pred_in_art_mcmc.json" #spikein data replaces full dataset, art model

SWEEPS=${SWEEPS:-100}
OUT_ROOT="${OUT_ROOT:-$PRED_OUT_DIR/spikeins/inform_adjust/art}"

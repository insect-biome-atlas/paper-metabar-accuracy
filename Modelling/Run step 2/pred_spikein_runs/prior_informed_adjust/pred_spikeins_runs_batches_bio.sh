...
#chmod +x pred_spikeins_runs_batches_bio.sh
#./pred_spikeins_runs_batches_bio.sh
...
ORIG_JSON="$DATA_DIR/modified_pred_in_bio_mcmc.json" #spikein data replaces full dataset, bio model

SWEEPS=${SWEEPS:-100}
OUT_ROOT="${OUT_ROOT:-$PRED_OUT_DIR/spikeins/inform_adjust/bio}"
